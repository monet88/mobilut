...
| Spark (explorer/fast) | `gpt-5.4-mini` | low | Fast triage, explore, lightweight synthesis, and low-latency routing. |
...
| `explore` | `gpt-5.4-mini` | low | Fast codebase search and file/symbol mapping (fast-lane, fast) |
...
| `style-reviewer` | `gpt-5.4-mini` | low | Formatting, naming, idioms, lint conventions (fast-lane, fast) |
...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1776232313087-ibklk5 | 2026-04-15T05:51:53.147Z
